...
export const duas: Dua[] = [
...

  {
    ...
    reminder: 'daily',
    audioUrl: 'https://download.media.islamway.net/lessons/MsharyAL3afasy/347_MasharyRashed_AzkarAlyom/04.mp3',
    reciter: 'Mishary Al-Afasy',
...

  {
    ...
    category: 'quotidiennes',
    reminder: 'daily',
    audioUrl: 'https://download.media.islamway.net/lessons/MsharyAL3afasy/347_MasharyRashed_AzkarAlyom/05.mp3',
    reciter: 'Mishary Al-Afasy',
...

  {
    ...
    category: 'quotidiennes',
    reminder: 'none',
    audioUrl: 'https://download.media.islamway.net/lessons/MsharyAL3afasy/347_MasharyRashed_AzkarAlyom/02.mp3',
    reciter: 'Mishary Al-Afasy',
...

  {
    ...
    frenchName: 'Dua avant de Dormir',
    description: 'Invocation et adhkar à réciter avant de s\'endormir pour se placer sous la protection d\'Allah pendant la nuit.',
    ...
    category: 'quotidiennes',
    reminder: 'daily',
    audioUrl: 'https://download.media.islamway.net/lessons/MsharyAL3afasy/347_MasharyRashed_AzkarAlyom/06.mp3',
    reciter: 'Mishary Al-Afasy',
    keywords: ['dormir', 'nuit', 'nawm', 'coucher', 'sommeil'],
    sections: [
      {
        id: 1,
        arabic: '[PLACEHOLDER - Texte arabe de Dua avant de Dormir]',
        french: '[PLACEHOLDER - Traduction française de Dua avant de Dormir]',
        phonetic: '[PLACEHOLDER - Phonétique de Dua avant de Dormir]',
      },
    ],
  },

  {
    ...
    frenchName: 'Dua au Réveil',
    description: 'Invocation à réciter au réveil pour remercier Allah de nous avoir redonné la vie après le sommeil.',
    occasion: 'Au réveil',
    duration: '2 min',
    durationMinutes: 2,
    importance: 'moyenne',
    category: 'quotidiennes',
    reminder: 'daily',
    audioUrl: 'https://download.media.islamway.net/lessons/MsharyAL3afasy/347_MasharyRashed_AzkarAlyom/01.mp3',
    reciter: 'Mishary Al-Afasy',
    keywords: ['réveil', 'matin', 'istiqaz', 'lever'],
    sections: [
      {
        id: 1,
        arabic: '[PLACEHOLDER - Texte arabe de Dua au Réveil]',
        french: '[PLACEHOLDER - Traduction française de Dua au Réveil]',
        phonetic: '[PLACEHOLDER - Phonétique de Dua au Réveil]',
      },
    ],
  },

  {
    ...
    frenchName: 'Dua après le Repas',
    description: 'Invocation à réciter après avoir mangé pour remercier Allah de sa provision.',
    occasion: 'Après les repas',
    duration: '1 min',
    durationMinutes: 1,
    importance: 'moyenne',
    category: 'quotidiennes',
    reminder: 'none',
    audioUrl: 'PLACEHOLDER_AUDIO_URL_APRES_REPAS',
    reciter: 'Mishary Al-Afasy',
    keywords: ['repas', 'manger', 'nourriture', 'après', 'remerciement'],
    sections: [
      {
        id: 1,
        arabic: '[PLACEHOLDER - Texte arabe de Dua après le Repas]',
        french: '[PLACEHOLDER - Traduction française de Dua après le Repas]',
        phonetic: '[PLACEHOLDER - Phonétique de Dua après le Repas]',
      },
    ],
  },

  {
    ...
    frenchName: 'Dua en Entrant dans la Maison',
    description: 'Invocation à réciter en entrant dans la maison pour y faire entrer la baraka.',
    occasion: 'En entrant dans la maison',
    duration: '1 min',
    durationMinutes: 1,
    importance: 'moyenne',
    category: 'quotidiennes',
    reminder: 'none',
    audioUrl: 'PLACEHOLDER_AUDIO_URL_ENTREE',
    reciter: 'Mishary Al-Afasy',
    keywords: ['entrée', 'maison', 'retour', 'baraka'],
    sections: [
      {
        id: 1,
        arabic: '[PLACEHOLDER - Texte arabe de Dua en Entrant]',
        french: '[PLACEHOLDER - Traduction française de Dua en Entrant]',
        phonetic: '[PLACEHOLDER - Phonétique de Dua en Entrant]',
      },
    ],
  },

  {
    ...
    frenchName: 'Dua du Voyage',
    description: 'Invocation à réciter avant de partir en voyage pour demander la protection et la facilité d\'Allah.',
    occasion: 'Avant un voyage',
    duration: '2 min',
    durationMinutes: 2,
    importance: 'moyenne',
    category: 'quotidiennes',
    reminder: 'none',
    audioUrl: 'PLACEHOLDER_AUDIO_URL_VOYAGE',
    reciter: 'Mishary Al-Afasy',
    keywords: ['voyage', 'safar', 'déplacement', 'protection', 'route'],
    sections: [
      {
        id: 1,
        arabic: '[PLACEHOLDER - Texte arabe de Dua du Voyage]',
        french: '[PLACEHOLDER - Traduction française de Dua du Voyage]',
        phonetic: '[PLACEHOLDER - Phonétique de Dua du Voyage]',
      },
    ],
  },
  ...
  {
    id: 'dua-parents',
    arabicName: 'دعاء للوالدين',
    frenchName: 'Dua pour les Parents',
    description: 'Invocation pour demander à Allah de bénir, protéger et accorder sa miséricorde à nos parents.',
    occasion: 'À tout moment',
    duration: '2 min',
    durationMinutes: 2,
    importance: 'haute',
    category: 'quotidiennes',
    reminder: 'none',
    audioUrl: 'PLACEHOLDER_AUDIO_URL_PARENTS',
    reciter: 'Mishary Al-Afasy',
    keywords: ['parents', 'walidayn', 'père', 'mère', 'famille', 'miséricorde'],
    sections: [
      {
        id: 1,
        arabic: '[PLACEHOLDER - Texte arabe de Dua pour les Parents]',
        french: '[PLACEHOLDER - Traduction française de Dua pour les Parents]',
        phonetic: '[PLACEHOLDER - Phonétique de Dua pour les Parents]',
      },
    ],
  },
...

  {
    ...
    category: 'apres-priere',
    reminder: 'none',
    audioUrl: 'https://download.media.islamway.net/lessons/MsharyAL3afasy/347_MasharyRashed_AzkarAlyom/03.mp3',
    reciter: 'Mishary Al-Afasy',
